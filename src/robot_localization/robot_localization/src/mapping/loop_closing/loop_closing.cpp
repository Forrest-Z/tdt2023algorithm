...
//     Eigen::Matrix4d scan_pose_d = scan_pose.cast<double>();//暂时为了通过编译

//     Registration(map_cloud_ptr, scan_cloud_ptr, scan_pose_d, result_pose);

//     // 计算相对位姿
//     current_loop_pose_.pose = map_pose.inverse() * result_pose.cast<float>();
