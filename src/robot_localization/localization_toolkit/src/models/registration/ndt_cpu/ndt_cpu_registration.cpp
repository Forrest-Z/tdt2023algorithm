...
namespace robot_localization
{
    ...
    bool NDTCPURegistration::SetInputTarget(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_target)
    {
    ...
    bool NDTCPURegistration::ScanMatch(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_source,
    ...
    {   
        return ndt_cpu_.getFitnessScore();
        // return ndt_cpu_->getFitnessScore();
    }
