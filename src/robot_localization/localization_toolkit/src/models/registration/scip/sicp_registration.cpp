...
namespace robot_localization
{
    ...
    bool SICPRegistration::SetInputTarget(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_target)
    {
    ...
    bool SICPRegistration::ScanMatch(const pcl::PointCloud<pcl::PointXYZ>::Ptr &input_source,
