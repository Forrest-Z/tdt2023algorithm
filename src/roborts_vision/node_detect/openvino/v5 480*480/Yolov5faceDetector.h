...
namespace tdtml{
    ...
    */
        ...
        //释放资源
        bool uninit();
        void detet2origin(const Rect& dete_rect,Rect &out_rect,const vector<float> &points,vector<float> &out_points,float rate_to,int top,int left);
