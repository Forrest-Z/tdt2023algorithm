...
{   
    ...
    std::cout << fontColorCyanBold << "键入数字档位决定速度如: 1、2、3、4、5、6 对应 0.4 0.8 1.2 1.8 2.3 2.8 m/s" << fontColorReset << std::endl;
    std::cout << fontColorCyanBold << "键入q、w、e、a、s、d、z、x、c方向指定行进方向 " << fontColorReset << std::endl;
...
{   //首次获取the_way容器里对象的索引
    ...
    switch (keyboard_input)
    {
        ...
        case 'j':   x=0;y=0;angular_v=0.91;break;
        case 'k':   angular_v=0;break;
        case 'l':   x=0;y=0;angular_v=-0.91;break;
